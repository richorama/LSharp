...
; --------------------------------------------------------------------------------------------------
; A simple script to test the eventing and graphics of LSharp.  This script will draw two curves
; entirely with straight lines.
; --------------------------------------------------------------------------------------------------
...
; --------------------------------------------------------------------------------------------------
; Generate a list of points between the specified min and max.  The list will hold the number of
...
; --------------------------------------------------------------------------------------------------
; A recursive function that handles the drawing of the graph lines.  All the lines are drawn using
; the specified graphics object, and drawn in the given pen.  The lines are drawn against the
; specified horizontal (x) and vertical (y) planes.  All of the variable points are specified by the
; widths and heights lists.
; --------------------------------------------------------------------------------------------------
...
;
; Note that the form's styles are also updated.  This is to make the form double buffered and to
...
; --------------------------------------------------------------------------------------------------
; Attach a function to the new form's paint event.  This function will handle generating the points
; needed by the draw lines function.  That and call the draw lines function.
; --------------------------------------------------------------------------------------------------
...
; --------------------------------------------------------------------------------------------------
; Hook up to the resize event.  This is needed to make sure that the window's contents get properly
; redrawn when the window gets resized.
; --------------------------------------------------------------------------------------------------
...
; --------------------------------------------------------------------------------------------------
; Finally, enable the XP look and get things rolling using my-form as the application's "main form".
; --------------------------------------------------------------------------------------------------
